...
const PersonCard = ({ person, setShowEditModal, setselectedPerson, handleDelete }) => {
    ...
    return (
        <div className="col-span-12  md:col-span-6 lg:col-span-4  2xl:col-span-3 w-full max-w-md bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            <div className="flex flex-col items-center pb-6">
                ...
                <span className="text-center mt-2 px-5 text-sm text-gray-700 dark:text-gray-400">{person && person.description}</span>
